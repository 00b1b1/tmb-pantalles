export const APP_TEXTS = {
    ...
    configurator: {
        ...
        alertsSystem: "Sistema d'Alertes",
        officialAlerts: 'Alertes Oficials TMB',
        ...
        hideConfigLabel: 'Ocultar botó de configuració',
        configShortcut: "Usa 'c' per obrir el menú.",
        editCustomAlert: 'Editar Alerta Personalitzada',
        officialAlertDetails: "Detalls de l'alerta oficial",
        back: 'Tornar',
        save: 'Guardar Alerta',
        cancel: 'Cancel·lar',
        tmbMessage: 'Missatge TMB',
        documentation: "Documentació de l'API",
