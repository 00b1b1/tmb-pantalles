...
## 👨‍💻 Crèdits
Desenvolupat amb ❤️ per a la comunitat de transport de Barcelona per Ahmed Bibi (@b_1__b_1). No és una aplicació oficial de Transports Metropolitans de Barcelona (TMB).
